                ...
                if (currSel && !currSel.initalized) {
                    if (currSel.id === this.id + "_TargetClusters") {
                        ...
                        WsELK.GetConfigDetails({
                            ...
                            if (response.GetConfigDetailsResponse.IntegrateKibana === true) {
                                ...
                                currSel.set("content", dojo.create ("div",{
                                    innerHTML: "<p> Log Visualization is not configured, please check your confriguration manager settings.</p>",
