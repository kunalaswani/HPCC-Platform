                ...
                if (currSel.id === this.id + "_TargetClusters") {
                    ...
                    WsELK.GetConfigDetails({
                        ...
                        if (lang.exists("GetConfigDetailsResponse", response)) {
                            ...
                            var string123 = dojoConfig.urlInfo.pathname + "?Widget=IFrameWidget&src=" + elk.KibanaAddress + ":" + elk.KibanaPort + elk.KibanaEntryPointURI;
                            alert(string123)
                            console.log(string123)
                            currSel.set("content", dojo.create("iframe", {
                                
                                src: dojoConfig.urlInfo.pathname + "?Widget=IFrameWidget&src="+ elk.KibanaAddress + ":" + elk.KibanaPort + elk.KibanaEntryPointURI,
                                style: "border: 0; width: 100%; height: 100%"
                            }));
                        } else {
